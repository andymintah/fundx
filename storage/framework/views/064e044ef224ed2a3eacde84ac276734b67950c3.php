...
<div class="row">
  ...
  <form method="post" action="<?php echo e(action('CampaignController@store')); ?>" method="POST", enctype = "multipart/form-data">
...
<div class="col-md-3 col-lg-3 col-sm-3 pull-right">
          ...
          <div class="p-3">
            ...
            <ol class="list-unstyled">
              <li><a href="/campaign/">My campaign</a></li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/fundx/resources/views/campaign/create.blade.php ENDPATH**/ ?>