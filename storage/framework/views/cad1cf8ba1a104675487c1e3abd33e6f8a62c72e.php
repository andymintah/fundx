        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                                <a class="nav-link" href="/campaign">Fundraisers</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/donation">Donations</a>
                            </li><li class="nav-item">
                                <a class="nav-link" href="/campaign">Testimonials</a>
                            </li>
...
<?php /**PATH /Applications/MAMP/htdocs/fundx/resources/views/layouts/app.blade.php ENDPATH**/ ?>