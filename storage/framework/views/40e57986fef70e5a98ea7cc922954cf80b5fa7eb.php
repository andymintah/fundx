...
<div class="row">
  ...
  <form method="post" action="<?php echo e(route('donors.store')); ?>" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="campaign_id" value="<?php echo e($campaign_id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/fundx/resources/views/donors/create.blade.php ENDPATH**/ ?>